...
import { TemplatesModal } from "@/features/boards-templates/index";
import { useViewMode } from "../model/use-view-mode";
import { useTemplatesModal } from "../model/use-template-modal";

function BoardsListPage() {
  const boardsFilters = useBoardsFilters();
  const boardActions = useActionsBoards();
  const templateModalActions = useTemplatesModal();
  ...
  return (
    <>
      <TemplatesModal
        isOpen={templateModalActions.isOpen}
        onOpenChange={templateModalActions.close}
      />
      <BoardsListLayout
